...
export type PostComment = {
  ...
  content: string;
  created_at: string;
  author: Pick<Profile, "id" | "name" | "initials" | "avatar_bg" | "avatar_fg" | "avatar_url">;
...
export type EventWithMeta = EventRow & {
  host: Pick<Profile, "id" | "name" | "initials" | "avatar_bg" | "avatar_fg" | "avatar_url">;
  going_count: number;
  going_previews: Pick<Profile, "id" | "initials" | "avatar_bg" | "avatar_fg" | "avatar_url">[];
